// @dcgp-audit-ignore-file command-injection - the execSync call below already wraps each arg in JSON.stringify; the regex cannot see that the fix is inside the interpolation this matters.
