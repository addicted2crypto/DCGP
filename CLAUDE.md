...
Before any action, read those three in order. Editing this file does nothing; edit `AGENTS.md` or `HARDRULES.md` instead.

If the repo state disagrees with any document, `scripts/verify-dcgp.sh` is the tiebreaker.
